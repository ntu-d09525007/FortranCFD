...
USE VOF_DATA, ONLY : VOF_OLD, VOF_SX, VOF_SY, VOF_SZ
IMPLICIT NONE
INTEGER :: I,J,K
REAL(DP) :: A
REAL(DP),DIMENSION(-2:NODE_X+3,-2:NODE_Y+3,-2:NODE_Z+3) :: VOF
...
USE LS_DATA
USE VOF_DATA, ONLY : VOF_OLD, VOF_SX
USE DUMMY_DATA
implicit none
...
USE FLUID_PROPERTIES
USE LS_DATA
USE VOF_DATA, ONLY : VOF_OLD, VOF_SY
USE DUMMY_DATA
implicit none
integer :: i,j,k,ii,ib,BTN
real(kind=dp) :: a1,a3,xc,beta,alpha,isgn,a4,a5
...
USE FLUID_PROPERTIES
USE LS_DATA
USE VOF_DATA, ONLY : VOF_OLD, VOF_SZ
USE DUMMY_DATA
implicit none
integer :: i,j,k,ii,ib,BTN
real(kind=dp) :: a1,a3,xc,beta,alpha,isgn,a4,a5
