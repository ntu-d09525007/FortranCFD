...
USE LS_DATA
USE VOF_DATA
USE FLUID_PROPERTIES, ONLY : UH,VH,WH,P
use VORTEX_DATA
USE IBM_DATA
IMPLICIT NONE
INTEGER :: I,J,K
CHARACTER(3) :: NUM,MET,GRI

  
  !OPEN(UNIT=99,FILE=trim(NAME_OF_PROB)//MET//'_'//GRI//'_'//NUM//'.vtk')
  !OPEN(UNIT=99,FILE=trim(NAME_OF_PROB)//GRI//'_'//NUM//'.vtk')
  OPEN(UNIT=99,FILE=trim(NAME_OF_PROB)//'_'//NUM//'.vtk')
  ...
  CALL PLOT_VTK_SCALAR(99,"VOF",VOF)
  !CALL PLOT_VTK_SCALAR(99,"SOLID",SOLID_VOF)
  !CALL PLOT_VTK_SCALAR(99,"Curvature",CURV)
  !CALL PLOT_VTK_SCALAR(99,"Pressure",P)
