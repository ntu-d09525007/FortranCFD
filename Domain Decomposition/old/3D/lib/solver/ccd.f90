...
INTEGER:: I
 ...
 !For uxx eq.
  ...
  THIS%SS(THIS%IS) = ( 34.0_8 / 3.0_8 * THIS%F(THIS%IS) - 83.0_8 / 4.0_8 * THIS%F(THIS%IS+1) &
          &  +10.0_8 * THIS%F(THIS%IS+2) -7.0_8/12.0_8 * THIS%F(THIS%IS+3) ) / (THIS%Dx**2)
  ...
  !For I = N
   ...
   THIS%SS(THIS%IE) = ( 34.0_8 / 3.0_8 * THIS%F(THIS%IE) - 83.0_8 / 4.0_8 * THIS%F(THIS%IE-1) &
         &  +10.0_8 * THIS%F(THIS%IE-2) -7.0_8/12.0_8 * THIS%F(THIS%IE-3) ) / (THIS%Dx**2)
...
SUBROUTINE CCD_ROOTS_ALLOC(THIS,IS,IE,JS,JE,KS,KE,DX,DY,DZ,DT)
IMPLICIT NONE
