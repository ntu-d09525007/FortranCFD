...
real(8) :: dx,dy,dz
    ...
    !write(*,'(A,4I4)')"Local A size",p%of(0)%loc%mg(level)%n,p%of(0)%loc%mg(level)%nx,p%of(0)%loc%mg(level)%ny,p%of(0)%loc%mg(level)%nz
    !write(*,'(A,4I4)')"Global A size",p%mg%n,p%mg%nx,p%mg%ny,p%mg%nz
    ...
    !write(*,'(A15,2F10.1)')"I matrix",minval(p%mg%i),maxval(p%mg%i)
    !write(*,'(A15,2F10.1)')"J matrix",minval(p%mg%j),maxval(p%mg%j)
    !write(*,'(A15,2F10.1)')"K matrix",minval(p%mg%k),maxval(p%mg%k)
    !write(*,'(A15,2F10.1)')"Node matrix",minval(p%mg%node),maxval(p%mg%node)
    ...
    ! do i = 1, p%mg%n
        ! if(p%mg%i(i)>1 .and. p%mg%i(i)<p%mg%nx .and. &
        ! &  p%mg%j(i)>1 .and. p%mg%j(i)<p%mg%ny .and. &
        ! &  p%mg%k(i)>1 .and. p%mg%k(i)<p%mg%nz)then
        
            ! p%mg%A(i,i) = p%mg%A(i,i) + 2.0d0/(3.0*dx**2.0d0) + 2.0d0/(3.0*dy**2.0d0) + 2.0d0/(3.0*dz**2.0d0)
            
            ! ! ======================================
            
            ! p%mg%A(i, p%mg%node(p%mg%i(i)-1,p%mg%j(i),p%mg%k(i)) ) = p%mg%A(i, p%mg%node(p%mg%i(i)-1,p%mg%j(i),p%mg%k(i)) ) &
            ! & - 1.0d0 / (3.0d0*dx**2.0d0)
            
            ! p%mg%A(i, p%mg%node(p%mg%i(i)+1,p%mg%j(i),p%mg%k(i)) ) = p%mg%A(i, p%mg%node(p%mg%i(i)+1,p%mg%j(i),p%mg%k(i)) ) &
            ! & - 1.0d0 / (3.0d0*dx**2.0d0)
            
            ! p%mg%A(i, p%mg%node(p%mg%i(i),p%mg%j(i)-1,p%mg%k(i)) ) = p%mg%A(i, p%mg%node(p%mg%i(i),p%mg%j(i)-1,p%mg%k(i)) ) &
            ! & - 1.0d0 / (3.0d0*dy**2.0d0)
            ...
            ! p%mg%A(i, p%mg%node(p%mg%i(i)-1,p%mg%j(i)-1,p%mg%k(i)) ) = p%mg%A(i, p%mg%node(p%mg%i(i)-1,p%mg%j(i)-1,p%mg%k(i)) ) &
            ! & - 1.0d0 / (6.0d0*dx**2.0d0)
            
            ! p%mg%A(i, p%mg%node(p%mg%i(i)+1,p%mg%j(i)+1,p%mg%k(i)) ) = p%mg%A(i, p%mg%node(p%mg%i(i)+1,p%mg%j(i)+1,p%mg%k(i)) ) &
            ! & - 1.0d0 / (6.0d0*dx**2.0d0)
            
            ! p%mg%A(i, p%mg%node(p%mg%i(i)+1,p%mg%j(i)-1,p%mg%k(i)) ) = p%mg%A(i, p%mg%node(p%mg%i(i)+1,p%mg%j(i)-1,p%mg%k(i)) ) &
            ! & - 1.0d0 / (6.0d0*dy**2.0d0)
            ...
            ! p%mg%A(i, p%mg%node(p%mg%i(i),p%mg%j(i),p%mg%k(i)-1) ) = p%mg%A(i, p%mg%node(p%mg%i(i),p%mg%j(i),p%mg%k(i)-1) ) &
            ! & - 1.0d0 / (3.0d0*dz**2.0d0)
            ...
            ! p%mg%A(i, p%mg%node(p%mg%i(i)-1,p%mg%j(i),p%mg%k(i)-1) ) = p%mg%A(i, p%mg%node(p%mg%i(i)-1,p%mg%j(i),p%mg%k(i)-1) ) &
            ! & - 1.0d0 / (6.0d0*dx**2.0d0)
            ...
            ! p%mg%A(i, p%mg%node(p%mg%i(i),p%mg%j(i)-1,p%mg%k(i)-1) ) = p%mg%A(i, p%mg%node(p%mg%i(i),p%mg%j(i)-1,p%mg%k(i)-1) ) &
            ! & - 1.0d0 / (6.0d0*dx**2.0d0)
    ...
    ! call SGETRF(p%mg%n,p%mg%n,p%mg%A,p%mg%n,p%mg%ipiv,info)
    ! if (info.ne.0) stop 'Matrix is numerically singular!'
    ! call SGETRI(p%mg%n,p%mg%A,p%mg%n,p%mg%ipiv,p%mg%work,p%mg%n,info)
    ! if (info.ne.0) stop 'Matrix inversion failed!'
    
end subroutine

subroutine manager_mg_solve_exact(p)
implicit none
class(manager) :: p
...
!write(*,*)"Exact solver error:",error
