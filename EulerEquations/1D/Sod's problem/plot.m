...
weno = readtable('WENO_001.txt', 'HeaderLines', 1);
ocrwenold = readtable('OCRWENO-LD_001.txt','HeaderLines',1);
...
legend('Fine Grid Solution','WENO5, N=200','OCRWENO-LD, N=200','FontSize',14)
