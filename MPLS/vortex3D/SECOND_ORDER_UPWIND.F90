...
REAL(DP) :: UP,UM,VV,VP,VM,WW,WP,WM,CM,CR,CC,DETF,CURVK,FINX,A1,A2,A3,A4,A5,A6,A7,TMP
 ...
 DO I = 1, NODE_X-1
    ...
    A1=0.5_DP/DX*(UP*(3.0_DP*U(I,J,K)-4.0_DP*U(I-1,J,K)+U(I-2,J,K)) &
                 +UM*(-U(I+2,J,K)+4.0_DP*U(I+1,J,K)-3.0_DP*U(I,J,K)))
    
    A2=0.5_DP/DY*(VP*(3.0_DP*U(I,J,K)-4.0_DP*U(I,J-1,K)+U(I,J-2,K)) &
          +VM*(-U(I,J+2,K)+4.0_DP*U(I,J+1,K)-3.0_DP*U(I,J,K)))
    
    A3=0.5_DP/DZ*(WP*(3.0_DP*U(I,J,K)-4.0_DP*U(I,J,K-1)+U(I,J,K-2)) &
          +WM*(-U(I,J,K+2)+4.0_DP*U(I,J,K+1)-3.0_DP*U(I,J,K)))
       
    A4=1.0_DP/RE2X*CC*(U(I+1,J,K)-2.0_DP*U(I,J,K)+U(I-1,J,K))
   
    A5=1.0_DP/RE2Y*CC*(U(I,J+1,K)-2.0_DP*U(I,J,K)+U(I,J-1,K))
   
    A6=1.0_DP/RE2Z*CC*(U(I,J,K+1)-2.0_DP*U(I,J,K)+U(I,J,K-1))
 ...
 DO I = 1, NODE_X
    ...
    B1=0.5_DP/DX*(UP*(3.0_DP*V(I,J,K)-4.0_DP*V(I-1,J,K)+V(I-2,J,K)) &
          +UM*(-V(I+2,J,K)+4.0_DP*V(I+1,J,K)-3.0_DP*V(I,J,K)))
    
    B2=0.5_DP/DY*(VP*(3.0_DP*V(I,J,K)-4.0_DP*V(I,J-1,K)+V(I,J-2,K)) &
          +VM*(-V(I,J+2,K)+4.0_DP*V(I,J+1,K)-3.0_DP*V(I,J,K)))
    
    B3=0.5_DP/DZ*(WP*(3.0_DP*V(I,J,K)-4.0_DP*V(I,J,K-1)+V(I,J,K-2)) &
          +WM*(-V(I,J,K+2)+4.0_DP*V(I,J,K+1)-3.0_DP*V(I,J,K)))
   
    B4=1.0_DP/RE2X*CC*(V(I+1,J,K)-2.0_DP*V(I,J,K)+V(I-1,J,K))
   
    B5=1.0_DP/RE2Y*CC*(V(I,J+1,K)-2.0_DP*V(I,J,K)+V(I,J-1,K))
   
    B6=1.0_DP/RE2Z*CC*(V(I,J,K+1)-2.0_DP*V(I,J,K)+V(I,J,K-1))
...
SUBROUTINE VELC()
 ...
 DO I = 1, NODE_X
    ...
    C1=0.5_DP/DX*(UP*(3.0_DP*W(I,J,K)-4.0_DP*W(I-1,J,K)+W(I-2,J,K)) &
          +UM*(-W(I+2,J,K)+4.0_DP*W(I+1,J,K)-3.0_DP*W(I,J,K)))
    
    C2=0.5_DP/DY*(VP*(3.0_DP*W(I,J,K)-4.0_DP*W(I,J-1,K)+W(I,J-2,K)) &
          +VM*(-W(I,J+2,K)+4.0_DP*W(I,J+1,K)-3.0_DP*W(I,J,K)))
    
    C3=0.5_DP/DZ*(WP*(3.0_DP*W(I,J,K)-4.0_DP*W(I,J,K-1)+W(I,J,K-2)) &
          +WM*(-W(I,J,K+2)+4.0_DP*W(I,J,K+1)-3.0_DP*W(I,J,K)))

    C4=1.0_DP/RE2X*CC*(W(I+1,J,K)-2.0_DP*W(I,J,K)+W(I-1,J,K))
  
    C5=1.0_DP/RE2Y*CC*(W(I,J+1,K)-2.0_DP*W(I,J,K)+W(I,J-1,K))
  
    C6=1.0_DP/RE2Z*CC*(W(I,J,K+1)-2.0_DP*W(I,J,K)+W(I,J,K-1))
